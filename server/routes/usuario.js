...
app.get('/usuario', verificaToken, function(req, res) {
    ...
    Usuario.find({ estado: true }, 'nombre email role estado google img') //para filtrar campos
        .skip(desde)
        .limit(limite)
        .exec((err, usuarios) => {
            if (err) {
...
app.delete('/usuario/:id', [verificaToken, verificaAdmin_Role], function(req, res) {
    ...
    //Usuario.findByIdAndRemove(id, (err, usuarioBorrado) => { Para un borrado físico
